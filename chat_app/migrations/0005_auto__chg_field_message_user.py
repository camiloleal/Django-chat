...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'chat_app_message', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chat_app.UserProfile']))

    def backwards(self, orm):

        # Changing field 'Message.user'
        db.alter_column(u'chat_app_message', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'chat_app.message': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['chat_app.UserProfile']"})
        },
        u'chat_app.room': {
